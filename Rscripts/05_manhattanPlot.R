...
infileName <- file.path(paste0(baseDir,"/<PATH-TO-results>/","00_DMC_table.csv"))
...
for (r in 1:length(RE)){
  ...
  write.csv(out, paste0(baseDir,"/<PATH-TO-results>/",RE[r],"_DMRegions.csv"),row.names = FALSE)
  
  outDir<-paste0(baseDir,"/<PATH-TO-plots>/", RE[r],"_")
  ctxt <- c("CG","CHG","CHH")
